"""
Django settings for djweather project.
...
SECRET_KEY = 'django-insecure--18pa$jc&7l+xeko+^wm-a8beqz%h4nbzs*6uxp&i162*d@b(a'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'core.responses.exceptions.handlers.api_exception_handler',
}
...
CELERY_BROKER_URL = os.environ.get("HOST_REDIS", "redis://redis-djw:6379")
CELERY_RESULT_BACKEND = os.environ.get("HOST_REDIS", "redis://redis-djw:6379")
